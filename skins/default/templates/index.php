...
<div class="body_padded">
    ...
    <h2>WARNING!</h2>
    <p>Damn Vulnerable Web Application is damn vulnerable! <em>Do not upload it to your hosting provider's public html folder or any Internet facing servers</em>, as they will be compromised. It is recommend using a virtual machine (such as <?= $this->externalLink('https://www.virtualbox.org/','VirtualBox' ) ?> or <?= $this->externalLink('https://www.vmware.com/','VMware' ) ?>), which is set to NAT networking mode. Inside a guest machine, you can downloading and install <?= $this->externalLink('https://www.apachefriends.org/en/xampp.html','XAMPP' ) ?> for the web server and database.</p>
    <br />
    <h3>Disclaimer</h3>
    ...
    <ul>
        ...
        <li><?= $this->externalLink('http://sourceforge.net/projects/mutillidae/files/mutillidae-project/', 'NOWASP') ?> (formerly known as <?= $this->externalLink('http://www.irongeek.com/i.php?page=mutillidae/mutillidae-deliberately-vulnerable-php-owasp-top-10', 'Mutillidae' ) ?></li>
